...
const { updateProduct, createProduct, getAllProducts, deleteProduct, getProductDetails, createProductReview, deleteReview, getProductReviews } = require('../controllers/productionController');
